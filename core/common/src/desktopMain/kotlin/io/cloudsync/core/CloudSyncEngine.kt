...
public actual class CloudSyncEngine private actual constructor() {
    ...
    public actual fun initialize(config: String): CloudSyncEngine { return this }
    public actual suspend fun start(): SyncResult<Unit> { return SyncResult.success(Unit) }
    public actual suspend fun stop() {}
    public actual suspend fun syncNow(): SyncResult<Unit> { return SyncResult.success(Unit) }
